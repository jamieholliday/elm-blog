...
var _user$project$Types$Content = F4(
	function (a, b, c, d) {
		return {slug: a, contentType: b, name: c, title: d};
	});
var _user$project$Types$Post = {ctor: 'Post'};
var _user$project$Types$Page = {ctor: 'Page'};

var _user$project$Pages$index = {slug: '/', contentType: _user$project$Types$Page, name: 'index', title: 'Jamie Holliday'};
...
var _user$project$App$model = function (location) {
	return {
		ctor: '_Tuple2',
		_0: {
			history: {
			...
			currentContent: _user$project$Pages$index
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
...
var _user$project$App$main = A2(
	...
	{init: _user$project$App$model, view: _user$project$App$view, update: _user$project$App$update, subscriptions: _user$project$App$subscriptions})();

var Elm = {};
Elm['App'] = Elm['App'] || {};
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"App.Msg":{"args":[],"tags":{"UrlChange":["Navigation.Location"]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
}
