...
var _user$project$FetchContent$fetch = function (content) {
	return A2(
		...
		_user$project$Types$NewContent,
		_elm_lang$http$Http$getString(
			_user$project$FetchContent$getUrl(content)));
};
...
var _user$project$App$initialModel = function (location) {
	return {
		...
		currentContent: _user$project$Pages$home
	};
};
var _user$project$App$init = function (location) {
	return A2(
		_user$project$App$update,
		_user$project$Types$UrlChange(location),
		_user$project$App$initialModel(location));
};
var _user$project$App$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Types$UrlChange,
	{init: _user$project$App$init, view: _user$project$View$render, update: _user$project$App$update, subscriptions: _user$project$App$subscriptions})();
